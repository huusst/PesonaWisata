...
function KeranjangPage({
    ...
    const BuatPesanan = async () => {
        ...
        console.log(dataId);
        console.log(dataTotalPembayaran);
        ...
        try {
            ...
            if (response) {
                snapEmbed(response.data.pembayaran.data_pembayaran_snap_token, 'snap-container', {
                ...
                <>
                    {DataKeranjang.length === 0 ? (
                        <div className='d-flex flex-column justify-content-center align-item-center w-100' style={{ height: '60vh' }}>
                            ...
                            <span onClick={() => Navigate("/")} className='button-form w-25'>Mulai cari destinasimu!</span>
                        </div>
                    ) : (
                        <>
